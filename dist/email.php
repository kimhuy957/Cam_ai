...
?>
<div data-push="" data-responsive-width="768px" data-has-scrollable-region="" data-fullbleed="" class="mdk-drawer-layout js-mdk-drawer-layout" data-domfactory-upgraded="mdk-drawer-layout">
                    <div class="mdk-drawer-layout__content ps" data-perfect-scrollbar="" style="transform: translate3d(0px, 0px, 0px);">
                        ...
                        <div class="navbar border-bottom justify-content-start">
                            <a data-target="#email-drawer" data-toggle="sidebar" class="btn btn-sm btn-light active"><i class="material-icons icon--left">tune</i> Inbox</a>
                            <a href="" class="btn btn-sm btn-light ml-8pt"><i class="material-icons icon--left">edit</i> Compose</a>
                        </div>
                        <div class="container-fluid page__container page-section">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex mr-3">
                                    <p class="text-70 measure-paragraph-max">Dear Sean,<br><br>Thank you for contacting us, we are looking forward to talking to you and welcoming you in the XBody Family! <br><br>You have given us the following details in your message:</p>
                                    <blockquote class="border-left-3 pl-3">
                                        <p class="text-50 measure-paragraph-max">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur inventore corporis maxime ipsum animi, quo voluptate hic, accusantium qui beatae assumenda praesentium exercitationem cum enim nobis cumque, voluptates nesciunt quibusdam.</p>
                                    </blockquote>
                    ...
                    <div class="mdk-drawer sub-layout-drawer js-mdk-drawer" data-align="start" id="email-drawer" data-position="left" data-domfactory-upgraded="mdk-drawer" data-persistent="" data-opened=""><div class="mdk-drawer__scrim" style=""></div>
                        <div class="mdk-drawer__content " style="">
                            <div class="sidebar sidebar-left sidebar-light bg-white o-hidden ps" data-perfect-scrollbar="">
                                ...
                                <div class="list-group list-group-flush flex-shrink-0" style="position: relative; z-index: 0;">
                                        ...
                                        <div class="flex">
                                            <p class="m-0">
                                                <span class="d-flex align-items-center mb-1">
                                                    <a href="#" class="text-body"><strong>Sherri J. Cardenas</strong></a>
                                    ...
                                    <div class="list-group-item d-flex align-items-start border-left-3 border-left-primary">
                                        ...
                                        <div class="flex">
                                            <p class="m-0">
                                                <span class="d-flex align-items-center mb-1">
                                                    <a href="#" class="text-body"><strong>Jenell D. Matney</strong></a>
                                                    <small class="ml-auto text-muted">March 24</small>
                                                </span>
                                                <span class="d-flex align-items-end">
                                                    <span class="flex mr-3">
                                    ...
                                    <div class="list-group-item d-flex align-items-start bg-transparent">
                                        ...
                                        <div class="flex">
                                            <p class="m-0">
                                                <span class="d-flex align-items-center mb-1">
                                                    <a href="#" class="text-body"><strong>Joseph S. Ferland</strong></a>
                                    ...
                                    <div class="list-group-item d-flex align-items-start bg-transparent">
                                        ...
                                        <div class="flex">
                                            <p class="m-0">
                                                <span class="d-flex align-items-center mb-1">
                                                    <a href="#" class="text-body"><strong>UX Collective</strong></a>
                                                    <small class="ml-auto text-muted">Feb 28</small>
                                                </span>
                                                <span class="d-flex align-items-end">
                                                    <span class="flex mr-3">
                                                        <strong class="text-body mb-1">How to hire UX Researchers</strong><br>
                                                        <small class="text-muted" style="max-height: 2rem; overflow: hidden; position: relative; display: inline-block;">How to hire UX Researchers — and more design links this week How to test the skills of a UX researcher...</small>
                                                    </span>
                                                    <a href="" class="d-flex align-items-center mb-1">
                                                        <small class="text-muted mr-1">2</small>
                                                        <i class="material-icons icon-16pt">attachment</i>
                                    ...
                                    <div class="list-group-item d-flex align-items-start bg-transparent">
                                        ...
                                        <div class="flex">
                                            <p class="m-0">
                                                <span class="d-flex align-items-center mb-1">
                                                    <a href="#" class="text-body"><strong>Elizabeth J. Ohara</strong></a>
                                    ...
                                    <div class="list-group-item d-flex align-items-start bg-transparent">
                                        ...
                                        <div class="flex">
                                            <p class="m-0">
                                                <span class="d-flex align-items-center mb-1">
                                                    <a href="#" class="text-body"><strong>Kaci M. Langston</strong></a>
